...
<section class="section is-main-section">
            ...
            <div class="level is-mobile">
                ...
                <div class="level-item has-widget-icon">
                    <div class="is-widget-icon">
                        <span class="icon has-text-info is-large"><i class="mdi mdi-moon-full mdi-48px"></i></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="tile is-parent">
        <div class="card tile is-child">
            <a href="{{ route('staff.tickets.view', ['status' => 'open']) }}">
                <div class="card-content">
                    <div class="level is-mobile">
                        <div class="level-item">
                            <div class="is-widget-label">
    ...
    <div class="tile is-parent">
        <div class="card tile is-child">
            <a href="{{ route('staff.tickets.view', ['status' => 'closed']) }}">
                <div class="card-content">
                    <div class="level is-mobile">
                        <div class="level-item">
                            <div class="is-widget-label">
    ...
    <div class="tile is-parent">
        <div class="card tile is-child">
            <a href="{{ route('staff.tickets.view', ['status' => 'overdue']) }}">
                <div class="card-content">
                    <div class="level is-mobile">
                        <div class="level-item">
                            <div class="is-widget-label">
        ...
        <header class="card-header">
            <p class="card-header-title">
                ...
                <span class="tags has-addons">
                    ...
                    <span @class([ 'tag' , 'is-danger'=> session('status') === 'Overdue',
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span @class([ 'tag' , 'is-rounded' , 'is-success'=> $tagColor == 'Low',
                                ...
                                <td>
                                    <span @class([ 'tag' , 'is-rounded' , 'is-info'=> $ticket->status == 'new',
                                ...
                                <td>
                                    <div>
                                        <div class="buttons has-addons">
                                            ...
                                            <a class="button is-rounded is-small is-primary" href="{{ route('staff.ticket.manage', ['ticket' => $ticket->id]) }}">
                                        ...
                                        {{-- <button class="button is-rounded is-small is-primary" type="button">
                                                ...
                                                <a href={{ route('staff.tickets.edit', ['ticket' => $ticket->id]) }}>
                                        <button class="button is-rounded is-small is-info jb-modal" data-target="sample-modal" type="button">
                                            <span class="icon">
                                                <i class="mdi mdi-pencil"></i>
                                            </span>
                                        </button>
                                        </a>
                                        <button class="button is-rounded is-small is-danger jb-modal" data-target="sample-modal" type="button">
                                            <span class="icon">
                                                <i class="mdi mdi-trash-can-outline"></i>
                                            </span>
                                        </button> --}}
...
<div class="columns is-mobile is-multiline">
    ...
    <div class="column is-half pt-0">
        ...
        <div>
            <input type="date" id="duedate" value="{{ old('due_date') }}" name="due_date" data-close-on-select="false">
        </div>
