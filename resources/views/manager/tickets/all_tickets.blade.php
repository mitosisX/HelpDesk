                        ...
                        <div class="level is-mobile">
                            ...
                            <div class="level-item has-widget-icon">
                                <div class="is-widget-icon">
                                    <span class="icon has-text-grey-light is-large"><i class="mdi mdi-moon-full mdi-48px"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span @class([ 'tag' , 'is-rounded' , 'is-primary'=> $tagColor == 'Low',
                                ...
                                <td>
                                    <div>
                                        <div class="field has-addons">
                                            ...
                                            <a class="control" href={{ route('manager.ticket.manage', ['ticket' => $ticket->id]) }}>
                                                <button class="button is-small is-primary is-rounded" data-target="sample-modal" type="button">
                                                    <span class="icon">
                                                        <i class="mdi mdi-eye"></i>
                                                    </span>
                                                    <span>View</span>
