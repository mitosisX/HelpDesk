        ...
        <div class="columns is-multiline is-12">
            ...
            <div class="column box is-8">
                <div class="tabs is-centered">
                    <ul>
                        <li @class(['is-active'=> session('account-type') === 'admins'])><a href="{{ route('admin.accounts.view', ['type' => 'admin']) }}">Administrators</a></li>
                        <li @class(['is-active'=> session('account-type') === 'staff'])><a href="{{ route('admin.accounts.view', ['type' => 'staff']) }}">IT Staff</a></li>
                        <li @class(['is-active'=> session('account-type') === 'users'])><a href="{{ route('admin.accounts.view', ['type' => 'user']) }}">User</a></li>
                    </ul>
    ...
    <div id="create_modal" class="modal">
        ...
        <div class="modal-card">
            <header class="modal-card-head">
                <p class="modal-card-title">
                    <span class="icon"><i class="mdi mdi-account-multiple"></i></span>
                    <span>Staff Account - Upload CSV file</span>
                </p>
                <button class="delete" aria-label="close"></button>
            </header>
            <section class="modal-card-body">
                <div class="column">
                    <form action="{{ route('admin.account.staff.create') }}" method='POST' enctype="multipart/form-data">
                        @csrf
                        ...
                        {{-- <div class="columns is-mobile is-multiline">
                            ...
                            <div class="column is-half pt-0">
                                <label>Email</label>
                                <div>
                                    <input type="email" name="email" class="input" placeholder="Provide Email" required>
                                </div>
                            </div>
...
<div id="create_modal" class="modal">
    ...
    <div class="modal-card">
        ...
        <section class="modal-card-body">
            <div class="column">
                <form action="{{ route('admin.account.staff.create') }}" method='POST'>
                    @csrf
                    <div class="columns is-mobile is-multiline">
                        <div class="column is-half pt-0">
                            <label>Name</label>
