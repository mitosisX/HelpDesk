...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css2/bulma.min.css') }}">
    {{-- <link rel="stylesheet" href="{{ asset('css/sidebar-style.css') }}"> --}}
    <link rel="stylesheet" href="{{ asset('css2/extensions/modal-fx.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css2/extensions/bulma-radio-checkbox.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css2/extensions/bulma-badge.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css2/extensions/bulmatable.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css2/extensions/bulma-calendar.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css2/mdi/font/css/materialdesignicons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css2/styles.css') }}">
    <link rel="stylesheet" href="{{ asset('css2/tags.css') }}">
    <link rel="stylesheet" href="{{ asset('css2/dataTables.bulma.min.css') }}">
    @yield('title')
    @notifyCss
</head>
        ...
        <div class="column box is-2">
            ...
            <aside class="menu">
                ...
                <ul class="menu-list">
                    ...
                    <li><a href="{{ route('admin.tickets.create') }}">Create Ticket</a></li>
